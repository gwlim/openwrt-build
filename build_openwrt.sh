...
sed -i 's/CONFIG_NFS_COMMON=y/# CONFIG_NFS_COMMON is not set/g' ./target/linux/generic/config-6.6
sed -i 's/CONFIG_NFS_V3=y/# CONFIG_NFS_V3 is not set/g' ./target/linux/generic/config-6.6
...
echo CONFIG_PRINTER=n >> ./target/linux/generic/config-6.6
echo CONFIG_NF_CONNTRACK_CHAIN_EVENTS=y >> ./target/linux/generic/config-6.6

#ATH79
sed -i 's/CONFIG_BLK_MQ_PCI=y/# CONFIG_BLK_MQ_PCI is not set/' ./target/linux/ath79/config-6.6
